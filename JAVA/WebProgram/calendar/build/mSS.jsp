    ...
    <td style="padding:10px;"><table width="800" cellspacing="5" cellpadding="0" style="border:thin; border-style:solid; border-width:1px; border-color:#DDD;">
      <tr>
       <td width="180" height="250" bgcolor="#FFFFFF"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/rollup2.png',1)"><img src="images/rollup1.png" width="180" height="250" id="Image5" /></a></td>
        ...
        <img src="images/mSS_logo.jpg" width="679" height="106" alt="mSS_logo" />
          <table width="679" height="447" border="0">
            <tr>
              <td width="339" height="377" align="center"><a href="etude.html">
              <img src="images/et_mSS.PNG" width="339" height="339" alt="et_mSS" /></a></td>
              <td width="339" align="center"><a href="theFace.html"><img src="images/tf_mSS.PNG" width="339" height="339" alt="tf_mSS" /></a></td>
            </tr>
            <tr>
              <td width="339" height="54" align="center">
              <iframe src="button.jsp" name="button" height="80%"  width="78%"  frameborder="0" scrolling="no" onLoad="setIFrameHeight(this)"></iframe>
        	  </td>
              <td width="339" align="center" bgcolor="#ffffff">
              <iframe src="button2.jsp" name="button2" height="50%"  width="78%"  frameborder="0" scrolling="no" onLoad="setIFrameHeight(this)"></iframe>
        	  </td>
        ...
        <td width="15" rowspan="2" valign="top">&nbsp;</td>
        <td width="10" height="10" rowspan="2" valign="top" bgcolor="#D6D6D6">          &nbsp;</td>
      </tr>
      <tr>
        ...
        <td width="180"><table width="180" border="0" cellpadding="7" cellspacing="2">
          <nav role='navigation'>
			  <ul>
			    <li><a href="12-03-final.html">Main</a></li>
			    <li class="active"><a href="mSS.jsp">이달의 신상</a></li>
