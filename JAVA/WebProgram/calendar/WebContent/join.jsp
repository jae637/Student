...
<table width="820" border="0" align="center" cellpadding="2" cellspacing="0" style="border-style:solid; border-color:#CCC; border-width:1px; background-color:rgba(255,255,255,1)">
  ...
  <tr>
    <td height="15" align="right" bgcolor="#000000"><img src="images/login.png" alt="로그인" title="로그인" width="100" height="25" border="0" usemap="#Map" /> <img src="images/join.png" alt="회원가입" title="회원가입" width="100" height="25" border="0" usemap="#Map2" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding:10px;"><table width="800" cellspacing="5" cellpadding="0" style="border:thin; border-style:solid; border-width:1px; border-color:#DDD;">
      <tr>
       <td width="180" height="250" bgcolor="#FFFFFF"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/rollup2.png',1)"><img src="images/rollup1.png" width="180" height="250" id="Image5" /></a></td>
        ...
        <center>
	<p><img src="images/join_logo.jpg" width="679" height="298" alt="join_logo" /></p>
	
	<form action="joinok.jsp" method="post" name="insertFrm" id = "insertFrm" >
	<table border="3" bordercolor="pink">
	
	<tr>
		<td bgcolor="pink" align="center">아이디</td>
		<td><input type="text" name="id"/>
			<input type="button" name="confirm_id" value="중복확인" onclick="openConfirmid(this.form)" /></td>
	</tr>
	
	<tr>
		<td bgcolor="pink" align="center">비밀번호</td>
		<td><input type="password" name="password"/></td>
	</tr>
		
	<tr>
		<td bgcolor="pink" align="center">비밀번호 질문</td>
		<td><select name="question">
				<option value="기억에 남는 장소는">기억에 남는 장소는</option>
				<option value="나의 출신 고교는">나의 출신 고교는</option>
				<option value="나의 보물 1호는">나의 보물 1호는</option>
				<option value="자신의 인생의 좌우명은">자신의 인생의 좌우명은</option>
				<option value="추억하고 싶은 날짜가 있다면">추억하고 싶은 날짜가 있다면</option>
			</select></td>
	</tr>		
	
	<tr>
		<td bgcolor="pink" align="center">질문 답변</td>
		<td><input type="text" align="center" size="50" name="answer"/></td>
	</tr>		
	...
	<tr>
		...
		<td><input type="text" size="15" name="number1">
			- <input type="text" size="15" name="number2"/></td>
	</tr>
				
	<tr>
		<td bgcolor="pink" align="center">주소</td>
		<td><input type="text" size="50" name="address"/></td>
	</tr>
	
	<tr>
		<td bgcolor="pink" align="center">연락처</td>
		<td><select name="phone1">
				<option value="010">010</option>
		</select> - <input type="text" size="6"	name="phone2">	
				  - <input type="text" size="6"	name="phone3"></td>
	 </tr>
	 
	 <tr>
		<td bgcolor="pink" align="center">이메일</td>
	...
	<br/>
	<input type="button" value="확인" id="insert" OnClick="javaScript:Insert();"> <input type="button" value="취소" onclick="location.href='login.jsp'"> 
	</form>
	</center>      
        &nbsp;</td>
        ...
        <script type="text/javascript">
		 function Insert()
	        ...
	        if( !insertFrm.answer.value ){
		          alert( "답변을 입력하세요." );
		          insertFrm.answer.focus();
		          return;
		         }
	        ...
	        if( !insertFrm.number1.value ){
		          alert( "주민등록번호를 입력하세요." );
		          insertFrm.number1.focus();
		          return;
		         }
	        if( !insertFrm.number2.value ){
		          alert( "주민등록번호를 입력하세요." );
		          insertFrm.number2.focus();
		          return;
		         }
	        ...
	        if( !insertFrm.phone2.value ){
		          alert( "연락처를 입력하세요." );
		          insertFrm.phone2.focus();
		          return;
		         }
	        if( !insertFrm.phone3.value ){
		          alert( "연락처를 입력하세요." );
		          insertFrm.phone3.focus();
		          return;
		         }
	        if( !insertFrm.email1.value ){
		          alert( "이메일을 입력하세요." );
		          insertFrm.email1.focus();
		          return;
		         }
	...
	function openConfirmid(inputid)
      ...
      open(url, "confirm", "toolbar=no,location=no,status=no,menubar=no,scrolbars=no,resizable=no,width=310,height=180");
      }
	</script>    
        ...
        <td width="180"><table width="180" border="0" cellpadding="7" cellspacing="2">
          <nav role='navigation'>
			  <ul>
			    ...
			    <li><a href="mSl.jsp">이달의 세일정보</a></li>
  ...
  <map name="Map" id="Map">
  <area shape="rect" coords="1,2,98,25" href="login.jsp" />
<map name="Map2" id="Map2">
  <area shape="rect" coords="2,3,99,24" href="join.jsp" />
  <tr>
