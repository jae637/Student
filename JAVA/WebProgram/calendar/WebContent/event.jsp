    ...
    <td style="padding:10px;"><table width="800" cellspacing="5" cellpadding="0" style="border:thin; border-style:solid; border-width:1px; border-color:#DDD;">
      <tr>
       <td width="180" height="250" bgcolor="#FFFFFF"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/rollup2.png',1)"><img src="images/rollup1.png" width="180" height="250" id="Image5" /></a></td>
        ...
        <p><img src="images/event_logo.jpg" width="690" height="115" alt="event_logo" /></p>
        <table width="660" height="396" border="0">
            <tr>
              <td width="375" height="179"><img src="images/etude_c.jpg" width="350" height="172" alt="etude_c" /></td>
              <td width="275"><img src="images/nature_c.jpg" width="350" height="170" alt="nature_c" /></td>
            </tr>
            <tr align="center">
              <td><input type="submit" name="button" id="button1" onclick="document.location.href='eventButton1.jsp'" value="신청하기" /></td>
              <td><input type="submit" name="button" id="button2" onclick="document.location.href='eventButton2.jsp'" value="신청하기" /></td>
            </tr>
            <tr align="center">
              <td><img src="images/1000p_up.jpg" width="183" height="39" alt="1000p_up" /></td>
              <td><img src="images/2000p_up.jpg" width="183" height="39" alt="2000p_c" /></td>
            </tr>
            <tr>
              <td><img src="images/theface_c.jpg" width="350" height="179" alt="theface_c" /></td>
              <td>&nbsp;</td>
            </tr>
            <tr align="center">
              <td><input type="submit" name="button" id="button3" onclick="document.location.href='eventButton3.jsp'" value="신청하기" /></td>
              <td>&nbsp;</td>
            </tr>
            <tr align="center">
              <td><img src="images/5000p_up.jpg" width="183" height="39" alt="5000p_up" /></td>
              <td>&nbsp;</td>
            </tr>
		</table>
		&nbsp;</td>
      ...
      <tr>
        ...
        <td width="180"><table width="180" border="0" cellpadding="7" cellspacing="2">
          <nav role='navigation'>
			  <ul>
			    <li ><a href="loginAft.jsp">Main</a></li>
