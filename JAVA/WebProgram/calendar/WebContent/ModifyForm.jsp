...
<script type="text/javascript">
	...
	function init(){
		setComboValue("<%=member.getEmail2()%>");
	}
...
<table width="820" border="0" align="center" cellpadding="2" cellspacing="0" style="border-style:solid; border-color:#CCC; border-width:1px; background-color:rgba(255,255,255,1)">
    ...
    <td style="padding:10px;"><table width="800" cellspacing="5" cellpadding="0" style="border:thin; border-style:solid; border-width:1px; border-color:#DDD;">
      <tr>
       <td width="180" height="250" bgcolor="#FFFFFF"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/rollup2.png',1)"><img src="images/rollup1.png" width="180" height="250" id="Image5" /></a></td>
		...
		<img src="images/infoChange_logo.jpg" width="679" height="293" alt="infoChange_logo" />
		<br><br><br>
		...
		<form method="post" action="ModifyPro.jsp" 
			...
			<center><table id="table1">
				...
				<tr>
					<td id="title" class="td1">이름</td>
					<td><%=member.getName() %></td>
				</tr>
				
				<tr>
					<td id="title" class="td1">주소</td>
					<td>
				...
				<tr>
					<td id="title" class="td1">휴대전화</td>
					<td>
						<input type="text" name="phone" value="<%=member.getPhone1()+"-"+member.getPhone2() %>"/>
					</td>
				</tr>
					
				<tr>
					<td id="title" class="td1">이메일</td>
					<td>
			...
			<br><br>
			<center><input type="button" value="취소" onclick="javascript:window.location='loginAft.jsp'">
			<input type="submit" value="수정"/></center>
		</form>
        &nbsp;</td>
  ...
  <tr>
    <td align="right" bgcolor="#000000"><a href="#">탈퇴</td>
  </tr>
  <tr bgcolor="#000000">
