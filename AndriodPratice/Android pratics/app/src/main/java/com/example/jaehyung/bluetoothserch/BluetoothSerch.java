package com.example.jaehyung.bluetoothserch;
...
public class BluetoothSerch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetooth_serch);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                ...
                case BluetoothAdapter.ACTION_DISCOVERY_STARTED:
                    dataDevice.clear();
                    Toast.makeText(BluetoothSerch.this, "블루투스 검색 시작", Toast.LENGTH_SHORT).show();
                    break;
                //블루투스 디바이스 찾음
                ...
                case BluetoothAdapter.ACTION_DISCOVERY_FINISHED:
                    Toast.makeText(BluetoothSerch.this, "블루투스 검색 종료", Toast.LENGTH_SHORT).show();
