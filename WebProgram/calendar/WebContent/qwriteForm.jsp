...
<body bgcolor="<%=bodyback_c%>">
	<center>
		<b>글쓰기</b><br>
		<form method="post" name="qwriteform" action="qwritePro.jsp"
			...
			<table width="400" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td colspan="2" bgcolor="<%=value_c%>" align="center"><input
						type="submit" value="글 쓰기"> <input type="reset"
						value="다시 작성"> <input type="button" value="목록보기"
						onclick="window.location='qlist.jsp'"></td>
				</tr>
			</table>
			<%
				} catch (Exception ex) {
